...
class DashboardController extends Controller
{
    ...
    public function export()
    {
        ...
        $csvData[] = ['Total Revenue', formatStoreCurrency($dashboardData['metrics']['revenue'], $user->creatorId(), $storeId)];
        $csvData[] = [];
        ...
        foreach ($dashboardData['recentOrders'] as $order) {
            $csvData[] = [$order['order_number'], $order['customer'], formatStoreCurrency($order['amount'], $user->creatorId(), $storeId), $order['status']];
        }
        $csvData[] = [];
        ...
        foreach ($dashboardData['topProducts'] as $product) {
            $csvData[] = [$product['name'], $product['sold'], formatStoreCurrency($product['price'], $user->creatorId(), $storeId)];
        }
