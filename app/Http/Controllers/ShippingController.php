    ...
    public function export()
    {
        ...
        foreach ($shippings as $shipping) {
            $csvData[] = [
                ...
                $shipping->type === 'free_shipping' ? 'Free' : formatStoreCurrency($shipping->cost, $user->creatorId(), $currentStoreId),
                $shipping->zone_type ? ucfirst($shipping->zone_type) : 'All zones',
                $shipping->min_order_amount ? formatStoreCurrency($shipping->min_order_amount, $user->creatorId(), $currentStoreId) : 'No minimum',
