...
class TaxController extends BaseController
{
    ...
    public function show(string $id)
    {
        ...
        $stats['formatted_collected'] = formatStoreCurrency($stats['collected'], $user->creatorId(), $currentStoreId);
        $stats['formatted_total'] = formatStoreCurrency($stats['total'], $user->creatorId(), $currentStoreId);
        ...
        foreach ($products as $product) {
            $product->formatted_price = formatStoreCurrency($product->price, $user->creatorId(), $currentStoreId);
        }
