...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::middleware('permission:manage-pos')->group(function () {
            ...
            Route::get('pos/transactions/export', [\App\Http\Controllers\POSController::class, 'export'])->middleware('permission:view-transactions-pos')->name('pos.transactions.export');
