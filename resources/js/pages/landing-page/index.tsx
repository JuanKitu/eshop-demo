...
export default function LandingPage() {
  ...
  const pageTitle = superadminSettings?.titleText || 'StoreGo - Build Your Online Store';
  const metaDescription = superadminSettings?.metaDescription || 'Create beautiful, professional online stores with StoreGo. Everything you need to start selling online.';
