        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6" role="form" aria-label="Contact form">
                ...
                <button
                  type="submit"
                  disabled={processing}
                  className="w-full text-white px-8 py-4 rounded-lg transition-colors font-semibold cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          ...
          <div>
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                  {sectionData?.contact_info_title || t('Contact Information')}
                </h3>
                <p className="text-gray-600 mb-8">
                  {sectionData?.contact_info_description || t('We\'re here to help and answer any question you might have. We look forward to hearing from you.')}
                </p>
              </div>
              ...
              <div className="space-y-6">
                {settings?.contact_email && (
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900 mb-1">{t('Email Us')}</h4>
                ...
                {settings?.contact_phone && (
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900 mb-1">{t('Call Us')}</h4>
                ...
                {settings?.contact_address && (
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900 mb-1">{t('Visit Us')}</h4>
