...
import {
  FaFacebook, FaTwitter, FaLinkedin, FaInstagram, FaYoutube, FaTiktok,
  FaPinterest, FaSnapchat, FaWhatsapp, FaTelegram, FaReddit, FaDiscord,
  FaTwitch, FaGithub, FaGitlab, FaBehance, FaDribbble, FaMedium,
  FaThreads, FaXTwitter, FaVk, FaLine, FaWeibo, FaSkype, FaViber
            ...
            <div className="lg:col-span-2">
              <Link href={route("home")} className="mb-6 block transition-colors">
                {(() => {
                  ...
                  // Use brand settings which are now forced to superadmin context on landing page
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              <button 
                ...
                className="text-white px-6 py-3 rounded-lg transition-colors font-semibold cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-w-[120px]" 
