...
export default function SystemSettings({ 
  ...
  useEffect(() => {
    if (Object.keys(settingsData).length > 0) {
      ...
      setSystemSettings(prevSettings => ({
        ...
        registrationEnabled: mergedSettings.registrationEnabled === 'true' || mergedSettings.registrationEnabled === true || mergedSettings.registrationEnabled === '1' || (mergedSettings.registrationEnabled === undefined ? defaultSettings.registrationEnabled : false)
      }));
    }
  }, [settingsData]);
  ...
  const submitSystemSettings = (e: React.FormEvent) => {
    ...
    const cleanSettings = {
      ...
      registrationEnabled: Boolean((systemSettings as any).registrationEnabled)
    };
              ...
              <div className="grid gap-2 md:col-span-2">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    checked={(systemSettings as any).registrationEnabled}
