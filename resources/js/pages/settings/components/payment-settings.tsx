        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              {/* Cash on Delivery - Only for company users */}
              {user?.type === 'company' && (
              <PaymentMethodCard
              ...
              >
                <div className="space-y-2">
                  <p className="text-sm text-muted-foreground">
                    {t("Allow customers to pay cash when their order is delivered. No additional configuration required.")}
                  </p>
                </div>
              </PaymentMethodCard>
              )}
              ...
              >
                <div className="space-y-4">
                  <PaymentModeSelector
                    value={data.toyyibpay_mode as 'sandbox' | 'live'}
