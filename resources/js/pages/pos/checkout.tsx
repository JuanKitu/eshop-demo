...
export default function POSCheckout() {
  ...
  useEffect(() => {
    ...
    if (cartData) {
      ...
      } else if (settings?.enable_guest_checkout !== false) {
        customer = { id: 'walk-in', name: 'Walk-in Customer' };
      }
      
      if (!customer) {
        // Redirect back to POS if no valid customer when guest checkout is disabled
              ...
              <CardContent className="pt-6">
                <div className="flex flex-col items-center justify-center text-center space-y-2">
                  ...
                  <div className="flex space-x-2 mt-4">
                    ...
                    <Button 
                      onClick={() => transactionId && window.open(route('pos.receipt', transactionId!), '_blank')} 
                      className="flex-1"
                      variant="outline"
                    >
