    ...
    <>
      ...
      >
        ...
        <div className="relative h-96 bg-gray-900 overflow-hidden">
          <img
            src={post?.featured_image ? getImageUrl(post.featured_image) : `https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80`}
                ...
                <div className="flex flex-wrap items-center gap-8 text-gray-600 mb-8">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-black">{post?.author?.name || 'Anonymous'}</div>
                    </div>
                  </div>
