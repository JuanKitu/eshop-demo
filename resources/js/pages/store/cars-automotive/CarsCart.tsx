              ...
              <div className="bg-black text-white p-6 border-l-4 border-red-600 mb-12">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-black text-red-600">{formatCurrency(parseFloat(String(summary.total)) as any, storeSettings, currencies)}</div>
                        ...
                        <div className="lg:w-48 h-48 lg:h-auto relative bg-gray-100 overflow-hidden">
                          ...
                          {item.sale_price && parseFloat(String(item.sale_price)) < parseFloat(String(item.price)) && (
                            <div className="absolute top-3 left-3 bg-red-600 text-white px-3 py-1 text-xs font-bold">
                              -{Math.round(((parseFloat(String(item.price)) - parseFloat(String(item.sale_price))) / parseFloat(String(item.price))) * 100)}% OFF
                            </div>
                          )}
                    ...
                    <div className="space-y-4 mb-8">
                      <div className="flex justify-between border-b border-gray-700 pb-2">
                        ...
                        <span className="font-black text-white">
                          {formatCurrency(parseFloat(String(summary.subtotal)) as any, storeSettings, currencies)}
                        </span>
                      </div>
                      <div className="flex justify-between border-b border-gray-700 pb-2">
                      ...
                      <div className="flex justify-between border-b border-gray-700 pb-2">
                        ...
                        <span className="font-black text-white">
                          {formatCurrency(parseFloat(String(summary.tax)) as any, storeSettings, currencies)}
                        </span>
                      </div>
                      <div className="border-t-2 border-red-600 pt-4">
                        <div className="flex justify-between">
                          ...
                          <span className="text-3xl font-black text-red-600">
                            {formatCurrency(parseFloat(String(summary.total)) as any, storeSettings, currencies)}
                          </span>
                        </div>
                      </div>
                    </div>
