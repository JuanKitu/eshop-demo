...
function CarsCheckout({
  ...
  const updatedCartSummary = {
    ...
    discount,
    total: parseFloat(String(cartSummary.subtotal)) - parseFloat(String(discount)) + parseFloat(String(shippingCost)) + parseFloat(String(cartSummary.tax)),
  };
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 ${shippingErrors.shippingFirstName ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 ${shippingErrors.shippingLastName ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                              } focus:outline-none transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 ${shippingErrors.shippingEmail ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                              } focus:outline-none transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 ${shippingErrors.shippingPhone ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                              } focus:outline-none transition-colors`}
                          />
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 ${shippingErrors.shippingStreet ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                              } focus:outline-none transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 border-2 ${shippingErrors.shippingState ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                              } focus:outline-none transition-colors`}
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 border-2 ${shippingErrors.shippingCity ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                              } focus:outline-none transition-colors`}
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 ${shippingErrors.shippingZip ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                              } focus:outline-none transition-colors`}
                          />
                        ...
                        <div className="space-y-3">
                          {shippingMethods.length > 0 ? (
                            shippingMethods.map((method) => {
                              ...
                              return (
                                <div key={method.id} className={`relative border-2 p-4 cursor-pointer transition-all duration-300 ${selectedShippingId === method.id ? 'border-red-600 bg-red-50' : 'border-gray-300 hover:border-red-400'
                                  }`}>
                                  <div className="flex items-center">
                                    <input
                    ...
                    <div className="space-y-8">
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {cartItems.map((item) => {
                            const itemPrice = parseFloat(String(item.sale_price || item.price));
                            ...
                            return (
                              <div key={item.id} className="flex items-center space-x-4 p-4 bg-gray-50 border-2 border-gray-200">
                                ...
                                <div className="flex-1">
                                  ...
                                  {item.variants && Object.keys(typeof item.variants === 'string' ? JSON.parse(item.variants) : item.variants).length > 0 && (
                                    <div className="flex flex-wrap gap-2 mt-1">
                                      {Object.entries(typeof item.variants === 'string' ? JSON.parse(item.variants) : item.variants).map(([key, value]: [string, any]) => (
                                        <span key={key} className="text-xs bg-red-100 text-red-700 px-2 py-0.5 font-medium">
                                          {key}: {value}
                                        </span>
                                      ))}
                                    </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          ...
                          {enabledPaymentMethods.cod && (
                            <div className={`relative border-2 p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'cod' ? 'border-red-600 bg-red-50' : 'border-gray-300 hover:border-red-400'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-cod"
                          ...
                          {enabledPaymentMethods.whatsapp && (
                            <div className={`relative border-2 p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'whatsapp' ? 'border-red-600 bg-red-50' : 'border-gray-300 hover:border-red-400'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-whatsapp"
                          ...
                          {enabledPaymentMethods.telegram && (
                            <div className={`relative border-2 p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'telegram' ? 'border-red-600 bg-red-50' : 'border-gray-300 hover:border-red-400'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-telegram"
                          ...
                          {Object.entries(enabledPaymentMethods).filter(([method]) => !['whatsapp', 'telegram', 'cod'].includes(method)).map(([method, config]: [string, any]) => {
                            ...
                            return (
                              <div key={method} className={`relative border-2 p-4 cursor-pointer transition-all duration-300 ${paymentMethod === method ? 'border-red-600 bg-red-50' : 'border-gray-300 hover:border-red-400'
                                }`}>
                                <div className="flex items-center">
                                  <input
                                    id={`payment-${method}`}
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`block w-full px-4 py-3 border-2 ${paymentErrors.whatsappNumber ? 'border-red-500' : 'border-gray-300 focus:border-red-600'
                                } focus:outline-none transition-colors`}
                            />
                ...
                <div className="bg-black text-white p-8 border-l-4 border-red-600 sticky top-8">
                      ...
                      return (
                        <div key={item.id} className="flex items-start space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {item.variants && Object.keys(typeof item.variants === 'string' ? JSON.parse(item.variants) : item.variants).length > 0 && (
                              <div className="flex flex-wrap gap-1 mt-1">
                                {Object.entries(typeof item.variants === 'string' ? JSON.parse(item.variants) : item.variants).map(([key, value]: [string, any]) => (
                                  <span key={key} className="text-xs bg-red-800 text-red-200 px-1.5 py-0.5 font-medium">
                                    {key}: {value}
                                  </span>
                                ))}
                              </div>
                          ...
                          <p className="text-sm font-bold text-red-400 flex-shrink-0">
                            {formatCurrency((itemPrice * item.quantity) as any, storeSettings as any, currencies as any)}
                          </p>
                        </div>
                      );
                    })}
                    ...
                    <div className="flex flex-col space-y-3">
                      ...
                      <div className="flex">
                        ...
                        <button
                          ...
                          className={`px-4 py-2 text-sm font-bold transition-colors ${couponApplied
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-gray-300 border-b border-gray-700 pb-2">
                      ...
                      <p className="font-black text-white">{formatCurrency(parseFloat(String(updatedCartSummary.subtotal)) as any, storeSettings, currencies)}</p>
                    </div>
                    ...
                    {updatedCartSummary.discount > 0 && (
                      <div className="flex justify-between text-green-400 border-b border-gray-700 pb-2">
                        ...
                        <p className="font-black">-{formatCurrency(parseFloat(String(updatedCartSummary.discount)) as any, storeSettings, currencies)}</p>
                      </div>
                    )}

                    <div className="flex justify-between text-gray-300 border-b border-gray-700 pb-2">
                      <p className="font-bold tracking-wider uppercase">Shipping</p>
                      <p className="font-black text-white">{selectedShippingId ? (parseFloat(String(updatedCartSummary.shipping)) === 0 ? 'FREE' : formatCurrency(parseFloat(String(updatedCartSummary.shipping)) as any, storeSettings, currencies)) : 'Select method'}</p>
                    </div>

                    <div className="flex justify-between text-gray-300 border-b border-gray-700 pb-2">
                      <p className="font-bold tracking-wider uppercase">Tax</p>
                      <p className="font-black text-white">{formatCurrency(parseFloat(String(updatedCartSummary.tax)) as any, storeSettings, currencies)}</p>
                    </div>
                    ...
                    <div className="flex justify-between text-xl font-black text-white pt-3 border-t-2 border-red-600">
                      ...
                      <p className="text-red-400">{formatCurrency(parseFloat(String(updatedCartSummary.total)) as any, storeSettings, currencies)}</p>
                    </div>
                  </div>
