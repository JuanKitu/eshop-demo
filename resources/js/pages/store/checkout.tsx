...
export default function Checkout({
  ...
  const handlePlaceOrder = async () => {
    ...
    if (paymentMethod === 'cashfree') {
      ...
      const redirectPaymentMethods = ['stripe', 'paypal', 'payfast', 'mercadopago', 'paystack', 'paytabs', 'coingate', 'tap', 'xendit', 'toyyibpay'];
                                  ...
                                  <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
                                    ...
                                    <div className="mt-4">
                                      ...
                                      <input
                                        ...
                                        className={`block w-full text-sm text-gray-900 border ${paymentErrors.bankTransferFile ? 'border-red-500' : 'border-gray-300'
                ...
                <div className="bg-gray-50 rounded-lg shadow-md p-6 sticky top-6">
                            ...
                            <div className="ml-4 flex flex-1 flex-col">
                              <div>
                                <div className="flex justify-between text-sm font-medium text-gray-900">
                                  ...
                                  <p className="ml-4">{formatCurrency(parseFloat(String(itemPrice)) * item.quantity, storeSettings as any, currencies as any)}</p>
                                </div>
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex justify-between text-sm text-gray-600">
                      <p>Subtotal</p>
                      <p>{formatCurrency(updatedCartSummary.subtotal || 0, storeSettings as any, currencies as any)}</p>
                    </div>

                    {updatedCartSummary.discount > 0 && (
                      <div className="flex justify-between text-sm text-green-600">
                        <p>Discount</p>
                        <p>-{formatCurrency(updatedCartSummary.discount || 0, storeSettings as any, currencies as any)}</p>
                      </div>
                    )}

                    <div className="flex justify-between text-sm text-gray-600">
                      <p>Shipping</p>
                      <p>{selectedShippingId ? formatCurrency(updatedCartSummary.shipping || 0, storeSettings as any, currencies as any) : 'Select method'}</p>
                    </div>

                    <div className="flex justify-between text-sm text-gray-600">
                      <p>Tax</p>
                      <p>{formatCurrency(updatedCartSummary.tax || 0, storeSettings as any, currencies as any)}</p>
                    </div>

                    <div className="flex justify-between text-base font-medium text-gray-900 pt-4 border-gray-200">
                      <p>Total</p>
                      <p>{formatCurrency(updatedCartSummary.total || 0, storeSettings as any, currencies as any)}</p>
                    </div>
                  </div>
