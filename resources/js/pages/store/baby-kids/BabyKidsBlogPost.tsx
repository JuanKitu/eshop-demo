        ...
        <div className="bg-pink-50 py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 lg:px-12 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-800 mb-6">{post?.title || 'Blog Post'}</h1>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-3xl shadow-lg border-2 border-pink-300 mx-6 lg:mx-12 -mt-8 overflow-hidden">
              <img
                ...
                onError={(e) => {
                  (e.target as HTMLImageElement).src = `https://placehold.co/1200x600/fef7f7/ec4899?text=${encodeURIComponent(post?.title || 'Blog Post')}`;
                }}
              />
            </div>
          </div>
