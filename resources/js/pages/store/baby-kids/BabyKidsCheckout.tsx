...
export default function BabyKidsCheckout({
  ...
  const { props } = usePage();
  const storeSettings = (props as any).storeSettings || {};
  const currencies = ((props as any).currencies as any) || [];
                ...
                return (
                  <div key={step.id} className="flex items-center">
                    <div className="flex flex-col items-center">
                      <div className={`w-16 h-16 rounded-full flex items-center justify-center transition-all duration-300 ${isCompleted ? 'bg-pink-500 text-white' :
                      ...
                      <span className={`mt-3 text-sm font-bold ${isActive ? 'text-pink-600' : isCompleted ? 'text-pink-500' : 'text-gray-400'
                        }`}>
                        {step.name}
                      </span>
                    </div>
                    {stepIdx < steps.length - 1 && (
                      <div className={`w-16 h-1 mx-4 rounded-full ${isCompleted ? 'bg-pink-500' : 'bg-gray-300'
                        }`}></div>
                    )}
                  </div>
                );
                      ...
                      <form onSubmit={handleShippingSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${shippingErrors.shippingFirstName ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                                }`}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${shippingErrors.shippingLastName ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                                }`}
                            />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${shippingErrors.shippingEmail ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                                }`}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${shippingErrors.shippingPhone ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                                }`}
                            />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${shippingErrors.shippingStreet ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                              }`}
                          />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <select
                              ...
                              className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${shippingErrors.shippingState ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                                }`}
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <select
                              ...
                              className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${shippingErrors.shippingCity ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                                }`}
                            >
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${shippingErrors.shippingZip ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                                }`}
                            />
                          ...
                          <div className="space-y-3">
                            {shippingMethods.length > 0 ? (
                              shippingMethods.map((method) => {
                                ...
                                return (
                                  <div key={method.id} className={`relative border-2 p-4 rounded-2xl cursor-pointer transition-all duration-300 ${selectedShippingId === method.id ? 'border-pink-500 bg-pink-50' : 'border-pink-300 hover:border-pink-400'
                                    }`}>
                                    ...
                                    {item.variants && Object.keys(typeof item.variants === 'string' ? JSON.parse(item.variants) : item.variants).length > 0 && (
                                      <div className="flex flex-wrap gap-1 mt-1 mb-1">
                                        {Object.entries(typeof item.variants === 'string' ? JSON.parse(item.variants) : item.variants).map(([key, value]: [string, any]) => (
                                          <span key={key} className="text-xs bg-pink-200 text-pink-700 px-2 py-0.5 rounded-full font-medium">
                                            {key}: {value}
                                          </span>
                                        ))}
                                      </div>
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            ...
                            {enabledPaymentMethods.cod && (
                              <div className={`relative border-2 p-4 rounded-2xl cursor-pointer transition-all duration-300 ${paymentMethod === 'cod' ? 'border-pink-500 bg-pink-50' : 'border-pink-300 hover:border-pink-400'
                                }`}>
                                <div className="flex items-center">
                                  <input
                                    id="payment-cod"
                            ...
                            {enabledPaymentMethods.whatsapp && (
                              <div className={`relative border-2 p-4 rounded-2xl cursor-pointer transition-all duration-300 ${paymentMethod === 'whatsapp' ? 'border-pink-500 bg-pink-50' : 'border-pink-300 hover:border-pink-400'
                                }`}>
                                <div className="flex items-center">
                                  <input
                                    id="payment-whatsapp"
                            ...
                            {enabledPaymentMethods.telegram && (
                              <div className={`relative border-2 p-4 rounded-2xl cursor-pointer transition-all duration-300 ${paymentMethod === 'telegram' ? 'border-pink-500 bg-pink-50' : 'border-pink-300 hover:border-pink-400'
                                }`}>
                                <div className="flex items-center">
                                  <input
                                    id="payment-telegram"
                            ...
                            {Object.entries(enabledPaymentMethods).filter(([method]) => !['whatsapp', 'telegram', 'cod'].includes(method)).map(([method, config]: [string, any]) => {
                              ...
                              return (
                                <div key={method} className={`relative border-2 p-4 rounded-2xl cursor-pointer transition-all duration-300 ${paymentMethod === method ? 'border-pink-500 bg-pink-50' : 'border-pink-300 hover:border-pink-400'
                                  }`}>
                                  <div className="flex items-center">
                                    <input
                                      id={`payment-${method}`}
                          ...
                          <div className="mt-6">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 border-2 rounded-2xl focus:outline-none transition-colors ${paymentErrors.whatsappNumber ? 'border-red-500' : 'border-pink-300 focus:border-pink-500'
                                  }`}
                              />
                ...
                <div className="relative bg-white rounded-3xl shadow-xl border-4 border-blue-400 p-8 sticky top-8">
                  ...
                  <div className="space-y-4 mb-6">
                    {cartItems.map((item) => {
                      ...
                      return (
                        <div key={item.id} className="flex items-start space-x-3 p-3 bg-blue-50 rounded-2xl">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {item.variants && Object.keys(typeof item.variants === 'string' ? JSON.parse(item.variants) : item.variants).length > 0 && (
                              <div className="flex flex-wrap gap-1 mt-1 mb-1">
                                {Object.entries(typeof item.variants === 'string' ? JSON.parse(item.variants) : item.variants).map(([key, value]: [string, any]) => (
                                  <span key={key} className="text-xs bg-blue-200 text-blue-700 px-1.5 py-0.5 rounded-md font-medium">
                                    {key}: {value}
                                  </span>
                                ))}
                              </div>
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-r-2xl font-bold text-sm transition-colors ${couponApplied
