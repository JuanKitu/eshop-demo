                        ...
                        <div key={item.id} className="flex items-center space-x-4 p-4 bg-pink-50 rounded-2xl">
                          ...
                          <div className="flex-1">
                            ...
                            {item.variant_name && item.variant_name !== 'default' && (
                              <p className="text-sm text-pink-600 font-medium my-1">{item.variant_name}</p>
                            )}
                          ...
                          <div className="text-lg font-bold text-pink-500">
                            {formatCurrency((parseFloat(String(item.price || 0)) * parseInt(String(item.quantity || 0))) as any, storeSettings as any, currencies as any)}
                          </div>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="border-t-2 border-pink-200 pt-6">
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-xl font-bold text-gray-800 pt-3 border-t-2 border-pink-400">
                          <span>Total</span>
                          <span className="text-pink-500">{formatCurrency(parseFloat(String(order.total || 0)) as any, storeSettings as any, currencies as any)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
