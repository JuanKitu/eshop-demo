...
export default function WatchesOrderConfirmation({
  ...
  const orderData: Order = (order || defaultOrder) as any;
                        ...
                        <tbody className="bg-white divide-y divide-slate-200">
                            ...
                            return (
                              <tr key={item.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm text-slate-600">
                                  {formatCurrency(item.price, storeSettings as any, currencies as any)}
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm text-slate-600">
                                  {item.quantity}
                                </td>
                          ...
                          {orderData.subtotal && orderData.subtotal > 0 && (
                            <tr>
                              ...
                              <td className="px-6 py-4 text-right text-sm text-slate-600">
                                {formatCurrency(orderData.subtotal, storeSettings as any, currencies as any)}
                              </td>
                            </tr>
                          )}
                          {orderData.discount && orderData.discount > 0 && (
                            <tr>
                              ...
                              <td className="px-6 py-4 text-right text-sm text-green-600">
                                -{formatCurrency(orderData.discount, storeSettings as any, currencies as any)}
                              </td>
                            </tr>
                          )}
                          {orderData.shipping && orderData.shipping > 0 && (
                            <tr>
                              ...
                              <td className="px-6 py-4 text-right text-sm text-slate-600">
                                {formatCurrency(orderData.shipping, storeSettings as any, currencies as any)}
                              </td>
                            </tr>
                          )}
                          {orderData.tax && orderData.tax > 0 && (
                            <tr>
                              ...
                              <td className="px-6 py-4 text-right text-sm text-slate-600">
                                {formatCurrency(orderData.tax, storeSettings as any, currencies as any)}
                              </td>
                            </tr>
                          )}
                          <tr className="bg-slate-50">
                            ...
                            <td className="px-6 py-4 text-right text-sm font-medium text-slate-900">
                              {formatCurrency(orderData.total, storeSettings as any, currencies as any)}
                            </td>
                          </tr>
                        </tbody>
                      </table>
