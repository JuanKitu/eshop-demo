                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center mb-4">
                                    {product.sale_price && parseFloat(String(product.sale_price)) > 0 ? (
                                      <>
                                        <span className="text-2xl font-bold text-amber-800">{formatCurrency(product.sale_price as any, storeSettings as any, currencies as any[])}</span>
                                        <span className="text-lg text-slate-500 line-through ml-3">{formatCurrency(product.price as any, storeSettings as any, currencies as any[])}</span>
                                      ...
                                      <span className="text-2xl font-bold text-amber-800">{formatCurrency(product.price as any, storeSettings as any, currencies as any[])}</span>
                                    )}
                                  </div>
                      ...
                      {Array.from({ length: Math.min(5, pagination.last_page) }, (_, i) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-4 py-2 border rounded-xl text-sm ${page === pagination.current_page
