...
function FurnitureCheckout({
  ...
  const { props } = usePage();
  const storeSettings = (props.storeSettings || {}) as any;
  ...
  const renderVariants = (item: any) => {
    ...
    if (!variants || typeof variants !== 'object' || Object.keys(variants).length === 0) return null;

    return (
      <div className="flex flex-wrap gap-2 mt-1">
        {Object.entries(variants).map(([key, value]: [string, any]) => (
  ...
  const [selectedBillingCountryName, setSelectedBillingCountryName] = useState('');
  const [selectedBillingStateName, setSelectedBillingStateName] = useState('');
  const [selectedBillingCityName, setSelectedBillingCityName] = useState('');
  ...
  const getShippingCost = () => {
    ...
    if (selectedShipping.type === 'free_shipping' && parseFloat(String(cartSummary.subtotal)) >= parseFloat(String(selectedShipping.min_order_amount || 0))) {
      return 0;
    }

    return parseFloat(String(selectedShipping.cost)) + parseFloat(String(selectedShipping.handling_fee || 0));
  };
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 rounded-xl ${shippingErrors.shippingFirstName ? 'border-red-500' : 'border-amber-200'
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 rounded-xl ${shippingErrors.shippingLastName ? 'border-red-500' : 'border-amber-200'
                              } focus:outline-none focus:border-amber-600 transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 rounded-xl ${shippingErrors.shippingEmail ? 'border-red-500' : 'border-amber-200'
                              } focus:outline-none focus:border-amber-600 transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 rounded-xl ${shippingErrors.shippingPhone ? 'border-red-500' : 'border-amber-200'
                              } focus:outline-none focus:border-amber-600 transition-colors`}
                          />
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 rounded-xl ${shippingErrors.shippingStreet ? 'border-red-500' : 'border-amber-200'
                              } focus:outline-none focus:border-amber-600 transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 border-2 rounded-xl ${shippingErrors.shippingState ? 'border-red-500' : 'border-amber-200'
                              } focus:outline-none focus:border-amber-600 transition-colors`}
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 border-2 rounded-xl ${shippingErrors.shippingCity ? 'border-red-500' : 'border-amber-200'
                              } focus:outline-none focus:border-amber-600 transition-colors`}
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border-2 rounded-xl ${shippingErrors.shippingZip ? 'border-red-500' : 'border-amber-200'
                              } focus:outline-none focus:border-amber-600 transition-colors`}
                          />
                        ...
                        <div className="space-y-3">
                          {shippingMethods.length > 0 ? (
                            shippingMethods.map((method) => {
                              ...
                              return (
                                <div key={method.id} className={`relative border-2 rounded-2xl p-4 cursor-pointer transition-all duration-300 ${selectedShippingId === method.id ? 'border-amber-600 bg-amber-50' : 'border-amber-200 hover:border-amber-400'
                                  }`}>
                                    ...
                                    <label htmlFor={`shipping-${method.id}`} className="ml-4 flex-1 cursor-pointer">
                                      <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-lg font-bold text-amber-800">
                                          {shippingCost === 0 ? 'Free' : formatCurrency(shippingCost as any, storeSettings, currencies)}
                                        </span>
                                      </div>
                                    </label>
                                  </div>
                      ...
                      <div>
                        ...
                        {!sameAsShipping && (
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-amber-50 rounded-2xl border border-amber-200">
                            {/* Billing First Name */}
                            <div>
                              <label htmlFor="billing-first-name" className="block text-sm font-bold text-amber-800 mb-2">
                                First Name *
                              </label>
                              <input
                                ...
                                className={`block w-full px-4 py-3 border-2 rounded-xl border-amber-200 focus:outline-none focus:border-amber-600 transition-colors`}
                              />
                            </div>

                            {/* Billing Last Name */}
                            <div>
                              <label htmlFor="billing-last-name" className="block text-sm font-bold text-amber-800 mb-2">
                                Last Name *
                              </label>
                              <input
                            ...
                            {/* Billing Email */}
                            <div>
                              <label htmlFor="billing-email" className="block text-sm font-bold text-amber-800 mb-2">
                                Email Address *
                              </label>
                              <input
                                id="billing-email"
                            ...
                            {/* Billing Phone */}
                            <div>
                              <label htmlFor="billing-phone" className="block text-sm font-bold text-amber-800 mb-2">
                                Phone Number *
                              </label>
                              <input
                                id="billing-phone"
                            ...
                            {/* Billing Street */}
                            <div className="md:col-span-2">
                              <label htmlFor="billing-street" className="block text-sm font-bold text-amber-800 mb-2">
                                Street Address *
                              </label>
                              <input
                                id="billing-street"
                            ...
                            {/* Billing Country */}
                            <div>
                              <label htmlFor="billing-country" className="block text-sm font-bold text-amber-800 mb-2">
                                Country *
                              </label>
                              <select
                                id="billing-country"
                            ...
                            {/* Billing State */}
                            <div>
                              <label htmlFor="billing-state" className="block text-sm font-bold text-amber-800 mb-2">
                                State / Province *
                              </label>
                              <select
                                id="billing-state"
                            ...
                            {/* Billing City */}
                            <div>
                              <label htmlFor="billing-city" className="block text-sm font-bold text-amber-800 mb-2">
                                City *
                              </label>
                              <select
                                id="billing-city"
                                value={billingCity}
                                onChange={(e) => {
                                  const selectedCity = billingCities.find((c: any) => c.id.toString() === e.target.value);
                                  setSelectedBillingCityName(selectedCity?.name || '');
                            ...
                            {/* Billing ZIP */}
                            <div>
                              <label htmlFor="billing-zip" className="block text-sm font-bold text-amber-800 mb-2">
                                ZIP / Postal Code *
                              </label>
                              <input
                                id="billing-zip"
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          ...
                          {enabledPaymentMethods.cod && (
                            <div className={`relative border-2 rounded-2xl p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'cod' ? 'border-amber-600 bg-amber-50' : 'border-amber-200 hover:border-amber-400'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-cod"
                          ...
                          {enabledPaymentMethods.whatsapp && (
                            <div className={`relative border-2 rounded-2xl p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'whatsapp' ? 'border-amber-600 bg-amber-50' : 'border-amber-200 hover:border-amber-400'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-whatsapp"
                          ...
                          {enabledPaymentMethods.telegram && (
                            <div className={`relative border-2 rounded-2xl p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'telegram' ? 'border-amber-600 bg-amber-50' : 'border-amber-200 hover:border-amber-400'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-telegram"
                          ...
                          {Object.entries(enabledPaymentMethods).filter(([method]) => !['whatsapp', 'telegram', 'cod'].includes(method)).map(([method, config]: [string, any]) => {
                            ...
                            return (
                              <div key={method} className={`relative border-2 rounded-2xl p-4 cursor-pointer transition-all duration-300 ${paymentMethod === method ? 'border-amber-600 bg-amber-50' : 'border-amber-200 hover:border-amber-400'
                                }`}>
                                <div className="flex items-center">
                                  <input
                                    id={`payment-${method}`}
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`block w-full px-4 py-3 border-2 rounded-xl ${paymentErrors.whatsappNumber ? 'border-red-500' : 'border-amber-200'
                                } focus:outline-none focus:border-amber-600 transition-colors`}
                            />
                ...
                <div className="bg-gradient-to-b from-yellow-50 to-amber-50 rounded-3xl shadow-lg border-2 border-yellow-200 p-6 sticky top-6">
                      ...
                      return (
                        <div key={item.id} className="flex items-center space-x-3">
                          ...
                          <p className="text-sm font-bold text-yellow-800">
                            {formatCurrency(parseFloat(String(itemPrice)) * item.quantity, storeSettings as any, currencies as any[])}
                          </p>
                        </div>
                      );
                    })}
                    ...
                    <div className="flex flex-col space-y-3">
                      ...
                      <div className="flex">
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-r-lg text-sm font-bold transition-colors ${couponApplied
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-slate-700">
                      <p>Subtotal</p>
                      <p>{formatCurrency(updatedCartSummary.subtotal as any, storeSettings, currencies)}</p>
                    </div>

                    {updatedCartSummary.discount > 0 && (
                      <div className="flex justify-between text-green-600">
                        <p>Discount</p>
                        <p>-{formatCurrency(updatedCartSummary.discount as any, storeSettings, currencies)}</p>
                      </div>
                    )}

                    <div className="flex justify-between text-slate-700">
                      <p>Shipping</p>
                      <p>{selectedShippingId ? formatCurrency(updatedCartSummary.shipping as any, storeSettings, currencies) : 'Select method'}</p>
                    </div>

                    <div className="flex justify-between text-slate-700">
                      <p>Tax</p>
                      <p>{formatCurrency(updatedCartSummary.tax as any, storeSettings, currencies)}</p>
                    </div>

                    <div className="flex justify-between text-xl font-bold text-yellow-800 pt-3 border-t-2 border-yellow-300">
                      <p>Total</p>
                      <p>{formatCurrency(updatedCartSummary.total as any, storeSettings, currencies)}</p>
                    </div>
                  </div>
