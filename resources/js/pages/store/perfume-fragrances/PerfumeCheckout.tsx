                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${shippingErrors.shippingFirstName ? 'border-red-500' : 'border-gray-300'
                              }`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${shippingErrors.shippingLastName ? 'border-red-500' : 'border-gray-300'
                              }`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${shippingErrors.shippingEmail ? 'border-red-500' : 'border-gray-300'
                              }`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${shippingErrors.shippingPhone ? 'border-red-500' : 'border-gray-300'
                              }`}
                          />
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${shippingErrors.shippingStreet ? 'border-red-500' : 'border-gray-300'
                              }`}
                          />
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${shippingErrors.shippingState ? 'border-red-500' : 'border-gray-300'
                              }`}
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${shippingErrors.shippingCity ? 'border-red-500' : 'border-gray-300'
                              }`}
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${shippingErrors.shippingZip ? 'border-red-500' : 'border-gray-300'
                              }`}
                          />
                        ...
                        <div className="space-y-3">
                          {shippingMethods.length > 0 ? (
                            shippingMethods.map((method) => {
                              ...
                              return (
                                <div key={method.id} className={`relative border-2 rounded-xl p-4 cursor-pointer transition-all duration-300 ${selectedShippingId === method.id ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'
                                  }`}>
                                  <div className="flex items-center">
                                    <input
                                    ...
                                    <label htmlFor={`shipping-${method.id}`} className="ml-4 flex-1 cursor-pointer">
                                      <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-lg font-medium text-purple-800">
                                          {shippingCost === 0 ? 'Free' : formatCurrency(shippingCost as any, storeSettings as any, currencies as any)}
                                        </span>
                                      </div>
                                    </label>
                                  </div>
                            ...
                            return (
                              <div key={item.id} className="flex items-center space-x-4 p-4 bg-stone-50 rounded-xl border border-purple-100">
                                ...
                                <div className="flex-1">
                                  ...
                                  {(item as any).variant_name && (item as any).variant_name !== 'default' && (
                                    <div className="text-sm text-purple-600">{(item as any).variant_name}</div>
                                  )}
                                  {(item as any).variants && Object.keys((item as any).variants).length > 0 && (
                                    <div className="text-sm text-purple-600">
                                      {Object.entries((item as any).variants).map(([key, value]) => (
                                ...
                                <div className="text-lg font-medium text-purple-800">
                                  {formatCurrency(itemTotal as any, storeSettings as any, currencies as any)}
                                </div>
                              </div>
                            );
                          })}
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          ...
                          {enabledPaymentMethods.cod && (
                            <div className={`relative border-2 rounded-xl p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'cod' ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-cod"
                          ...
                          {enabledPaymentMethods.whatsapp && (
                            <div className={`relative border-2 rounded-xl p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'whatsapp' ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-whatsapp"
                          ...
                          {enabledPaymentMethods.telegram && (
                            <div className={`relative border-2 rounded-xl p-4 cursor-pointer transition-all duration-300 ${paymentMethod === 'telegram' ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-telegram"
                          ...
                          {Object.entries(enabledPaymentMethods).filter(([method]) => !['whatsapp', 'telegram', 'cod'].includes(method)).map(([method, config]: [string, any]) => {
                            ...
                            return (
                              <div key={method} className={`relative border-2 rounded-xl p-4 cursor-pointer transition-all duration-300 ${paymentMethod === method ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'
                                }`}>
                                <div className="flex items-center">
                                  <input
                                    id={`payment-${method}`}
                          ...
                          <div className="mt-6">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`block w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${paymentErrors.whatsappNumber ? 'border-red-500' : 'border-gray-300'
                                  }`}
                              />
                ...
                <div className="bg-gradient-to-br from-purple-800 to-purple-900 text-white p-8 rounded-3xl sticky top-8 border border-purple-700">
                      ...
                      return (
                        <div key={item.id} className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {(item as any).variant_name && (item as any).variant_name !== 'default' && (
                              <p className="text-xs text-purple-300">{(item as any).variant_name}</p>
                            )}
                            {(item as any).variants && Object.keys((item as any).variants).length > 0 && (
                          ...
                          <p className="text-sm font-medium text-amber-400">
                            {formatCurrency((parseFloat(String(itemPrice)) * item.quantity) as any, storeSettings as any, currencies as any)}
                          </p>
                        </div>
                      );
                    })}
                    ...
                    <div className="flex flex-col space-y-3">
                      ...
                      <div className="flex">
                        ...
                        <button
                          ...
                          className={`px-4 py-2 text-sm font-medium rounded-r-lg transition-colors ${couponApplied
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-purple-200 border-b border-purple-700 pb-2">
                      ...
                      <p className="font-medium text-white">{formatCurrency(updatedCartSummary.subtotal as any, storeSettings as any, currencies as any)}</p>
                    </div>

                    {updatedCartSummary.discount > 0 && (
                      <div className="flex justify-between text-green-400 border-b border-purple-700 pb-2">
                        <p className="font-medium">Discount</p>
                        <p className="font-medium">-{formatCurrency(updatedCartSummary.discount as any, storeSettings as any, currencies as any)}</p>
                      </div>
                    )}

                    <div className="flex justify-between text-purple-200 border-b border-purple-700 pb-2">
                      <p className="font-medium">Shipping</p>
                      <p className="font-medium text-white">{selectedShippingId ? (updatedCartSummary.shipping === 0 ? 'FREE' : formatCurrency(updatedCartSummary.shipping as any, storeSettings as any, currencies as any)) : 'Select method'}</p>
                    </div>

                    <div className="flex justify-between text-purple-200 border-b border-purple-700 pb-2">
                      <p className="font-medium">Tax</p>
                      <p className="font-medium text-white">{formatCurrency(updatedCartSummary.tax as any, storeSettings as any, currencies as any)}</p>
                    </div>

                    <div className="flex justify-between text-xl font-medium text-white pt-3 border-t-2 border-amber-400">
                      <p>Total</p>
                      <p className="text-amber-400">{formatCurrency(updatedCartSummary.total as any, storeSettings as any, currencies as any)}</p>
                    </div>
                  </div>
