  ...
  return (
    <>
      ...
      <StoreLayout
        ...
        customFooter={<PerfumeFooter storeName={store?.name || 'Store'} logo={store?.logo} content={storeContent?.footer} />}
      >
        {/* Hero Section */}
              ...
              <div className="max-w-4xl mx-auto">
                <div className="relative overflow-hidden rounded-3xl">
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = `https://placehold.co/800x400/fafaf9/7c3aed?text=${encodeURIComponent(post?.title || 'Blog Post')}`;
                    }}
                  />
                </div>
              </div>
