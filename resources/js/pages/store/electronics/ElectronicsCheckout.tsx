                  ...
                  {steps.map((step, index) => {
                    ...
                    return (
                      <div key={step.id} className="flex items-center">
                        <div className={`flex items-center justify-center w-12 h-12 rounded-full border-2 ${isCompleted ? 'bg-blue-600 border-blue-600' :
                          isActive ? 'border-blue-600 bg-blue-50' : 'border-gray-300 bg-gray-50'
                          }`}>
                          <Icon className={`w-6 h-6 ${isCompleted ? 'text-white' :
                            isActive ? 'text-blue-600' : 'text-gray-400'
                            }`} />
                        </div>
                        <span className={`ml-3 font-semibold ${isActive ? 'text-blue-600' : isCompleted ? 'text-blue-600' : 'text-gray-500'
                          }`}>
                          {step.name}
                        </span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${shippingErrors.firstName ? 'border-red-500' : 'border-gray-300'
                                }`}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${shippingErrors.lastName ? 'border-red-500' : 'border-gray-300'
                                }`}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${shippingErrors.email ? 'border-red-500' : 'border-gray-300'
                                }`}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${shippingErrors.phone ? 'border-red-500' : 'border-gray-300'
                                }`}
                            />
                          ...
                          <div className="md:col-span-2">
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${shippingErrors.street ? 'border-red-500' : 'border-gray-300'
                                }`}
                            />
                          ...
                          <div>
                            ...
                            <select
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${shippingErrors.state ? 'border-red-500' : 'border-gray-300'
                                }`}
                            >
                          ...
                          <div>
                            ...
                            <select
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${shippingErrors.city ? 'border-red-500' : 'border-gray-300'
                                }`}
                            >
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${shippingErrors.zip ? 'border-red-500' : 'border-gray-300'
                                }`}
                            />
                            {shippingErrors.zip && (
                          ...
                          <div className="space-y-3">
                            {shippingMethods.map((method) => (
                              <label key={method.id} className="flex items-center p-4 border border-gray-200 rounded-lg hover:border-blue-300 cursor-pointer">
                                ...
                                <div className="font-bold text-blue-600">{formatCurrency(method.cost, storeSettings as any, currencies as any)}</div>
                              </label>
                            ))}
                          </div>
                        </div>
                        ...
                        <div className="mt-6">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${paymentErrors.whatsappNumber ? 'border-red-500' : 'border-gray-300'
                                }`}
                            />
                        ...
                        {cartItems.map((item) => (
                          <div key={item.id} className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg">
                              ...
                              {item.variants && Object.entries(item.variants).length > 0 && (
                                <div className="flex flex-wrap gap-2 mb-1">
                                  {Object.entries(item.variants).map(([key, value]) => (
                                    <span key={key} className="text-xs text-gray-500 italic bg-gray-100 px-1.5 py-0.5 rounded">
                                      {key}: {String(value)}
                                    </span>
                                  ))}
                                </div>
                            ...
                            <div className="font-bold text-blue-600">
                              {formatCurrency((item.sale_price || item.price) * item.quantity, storeSettings as any, currencies as any)}
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-6">
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{formatCurrency(cartSummary.subtotal, storeSettings as any, currencies as any)}</span>
                      </div>

                      {(cartSummary.discount || 0) > 0 && (
                        <div className="flex justify-between text-green-600">
                          <span className="text-gray-600">Discount</span>
                          <span className="font-semibold">-{formatCurrency(cartSummary.discount, storeSettings as any, currencies as any)}</span>
                        </div>
                      )}
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{formatCurrency(cartSummary.tax, storeSettings as any, currencies as any)}</span>
                      </div>
                      <div className="border-t border-gray-200 pt-4">
                        <div className="flex justify-between">
                          <span className="text-lg font-bold text-gray-900">Total</span>
                          <span className="text-lg font-bold text-blue-600">{formatCurrency(total, storeSettings as any, currencies as any)}</span>
                        </div>
                      </div>
                    </div>
