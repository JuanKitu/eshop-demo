                          ...
                          <div className="flex items-center gap-2 mb-4">
                            {hasDiscount ? (
                              <>
                                ...
                                <span className="text-lg text-gray-500 line-through">{formatCurrency(product?.price, storeSettings as any, currencies as any)}</span>
                              </>
                            ) : (
                              <span className="text-2xl font-bold text-gray-900">{formatCurrency(product?.price, storeSettings as any, currencies as any)}</span>
                            )}
                          </div>
