                          ...
                          return (
                            <div key={item.id} className="flex items-center space-x-4 p-4 border border-gray-200 rounded-xl hover:shadow-md transition-all">
                                ...
                                {item.variants && Object.entries(item.variants).length > 0 && (
                                  <div className="text-xs text-gray-500 font-medium mt-1">
                                    {Object.entries(item.variants).map(([key, value]) => (
                                      <span key={key} className="mr-3 bg-gray-100 px-2 py-0.5 rounded">
                                        {key}: <span className="text-gray-700">{String(value)}</span>
                                      </span>
                                    ))}
                                  </div>
                                )}
                              ...
                              <div className="text-right">
                                <p className="font-bold text-blue-600">{formatCurrency(itemTotal, storeSettings as any, currencies as any)}</p>
                    ...
                    <div className="p-6 space-y-4">
                      {orderData.subtotal && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">{formatCurrency(orderData.subtotal, storeSettings as any, currencies as any)}</span>
                        </div>
                      )}
                      ...
                      {orderData.discount && orderData.discount > 0 && (
                        <div className="flex justify-between text-green-600">
                          ...
                          <span className="font-semibold">-{formatCurrency(orderData.discount, storeSettings as any, currencies as any)}</span>
                        </div>
                      )}
                      ...
                      {orderData.shipping && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">{formatCurrency(orderData.shipping, storeSettings as any, currencies as any)}</span>
                        </div>
                      )}
                      ...
                      {orderData.tax && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">{formatCurrency(orderData.tax, storeSettings as any, currencies as any)}</span>
                        </div>
                      )}
                      ...
                      <div className="border-t border-gray-200 pt-4">
                        <div className="flex justify-between">
                          ...
                          <span className="text-lg font-bold text-blue-600">{formatCurrency(orderData.total, storeSettings as any, currencies as any)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
