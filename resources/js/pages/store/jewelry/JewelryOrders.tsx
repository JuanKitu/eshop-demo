              ...
              {orders.length > 0 ? (
                        ...
                        <div className="p-3">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              ...
                              <span className="font-semibold text-gray-900">{formatCurrency(order.total, storeSettings as any, currencies as any)}</span>
                            </div>
                            <Link
                ...
                <div className="p-16 text-center">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center px-8 py-4 bg-yellow-600 text-white rounded-lg font-medium hover:bg-yellow-700 transition-colors shadow-md hover:shadow-lg"
                  >
