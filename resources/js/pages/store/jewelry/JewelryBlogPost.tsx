  ...
  return (
    <>
      ...
      <StoreLayout
        ...
        customFooter={<JewelryFooter storeName={store?.name || 'Store'} logo={store?.logo} />}
      >
          ...
          <div className="container mx-auto px-4 py-8 relative z-10">
            ...
            <div className="flex items-center space-x-6 text-gray-600 mb-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-light">{post?.author?.name || 'Anonymous'}</span>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-yellow-200/50 p-4">
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = `https://placehold.co/1200x600/f5f5f5/d97706?text=${encodeURIComponent(post?.title || 'Blog Post')}`;
                  }}
                />
              </div>
            </div>
