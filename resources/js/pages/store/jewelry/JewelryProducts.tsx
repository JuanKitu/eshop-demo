                            ...
                            <div className="flex justify-between items-start h-full">
                              <div className="flex-1">
                                ...
                                <div className="flex items-center mb-6">
                                  {product.sale_price ? (
                                    <>
                                      <span className="text-3xl font-medium text-neutral-900">{formatCurrency(product.sale_price, storeSettings as any, currencies as any)}</span>
                                      <span className="text-lg text-neutral-500 line-through ml-3">{formatCurrency(product.price, storeSettings as any, currencies as any)}</span>
                                    ...
                                    <span className="text-3xl font-medium text-neutral-900">{formatCurrency(product.price, storeSettings as any, currencies as any)}</span>
                                  )}
                                </div>
                                <div className="flex items-center mb-6">
                                  {product.stock > 0 ? (
