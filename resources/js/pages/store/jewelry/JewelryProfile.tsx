...
import { User, Mail, Phone, MapPin, Lock, Eye, EyeOff, Calendar, Gem, Crown, Edit3, Save, ChevronDown } from 'lucide-react';
import {
  Select,
  SelectContent,
  SelectItem,
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-200">
                              ...
                              >
                                <SelectTrigger className="w-full h-auto px-4 py-3 bg-white border-2 border-yellow-200 rounded-lg focus:outline-none transition-colors font-medium text-gray-800">
                                  <SelectValue placeholder="Select Gender" />
                                </SelectTrigger>
                                <SelectContent className="bg-white border-yellow-100 rounded-lg shadow-xl">
                          ...
                          <div className="space-y-6">
                            <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                              ...
                              <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                                ...
                                >
                                  <SelectTrigger className="w-full h-auto px-4 py-3 bg-white border-2 border-purple-200 rounded-lg focus:outline-none transition-colors font-medium text-gray-800">
                                    <SelectValue placeholder="Select Country" />
                                  </SelectTrigger>
                                  <SelectContent className="bg-white border-purple-100 rounded-lg shadow-xl">
                              ...
                              <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                                ...
                                >
                                  <SelectTrigger className="w-full h-auto px-4 py-3 bg-white border-2 border-purple-200 rounded-lg focus:outline-none transition-colors font-medium text-gray-800 disabled:opacity-50">
