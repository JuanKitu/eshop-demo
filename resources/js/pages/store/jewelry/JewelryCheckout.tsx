...
function JewelryCheckout({
  ...
  const renderVariants = (variants: any, isSidebar: boolean = false) => {
    ...
    if (!parsedVariants || typeof parsedVariants !== 'object' || Object.keys(parsedVariants).length === 0) {
      return null;
    }

    return (
      <div className={`flex flex-wrap gap-1 ${isSidebar ? 'mt-0.5' : 'my-1'}`}>
        {Object.entries(parsedVariants).map(([key, value]) => (
          <span
            key={key}
            className={`text-[10px] italic rounded-full px-2 py-0.5 ${isSidebar
              ? 'text-white/60 bg-white/10 border border-white/20'
              : 'text-yellow-700 bg-yellow-50 border border-yellow-200 shadow-sm'
              }`}
          >
            {key}: {String(value)}
          </span>
                        ...
                        <form onSubmit={handleShippingSubmit} className="space-y-8">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 ${shippingErrors.shippingFirstName ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 ${shippingErrors.shippingLastName ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                                  } focus:outline-none transition-all duration-200 bg-white hover:border-yellow-300`}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 ${shippingErrors.shippingEmail ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                                  } focus:outline-none transition-all duration-200 bg-white hover:border-yellow-300`}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 ${shippingErrors.shippingPhone ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                                  } focus:outline-none transition-all duration-200 bg-white hover:border-yellow-300`}
                            ...
                            <div className="md:col-span-2">
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 ${shippingErrors.shippingStreet ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                                  } focus:outline-none transition-all duration-200 bg-white hover:border-yellow-300`}
                            ...
                            <div>
                              ...
                              <select
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 ${shippingErrors.shippingState ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                                  } focus:outline-none transition-all duration-200 bg-white hover:border-yellow-300`}
                              >
                            ...
                            <div>
                              ...
                              <select
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 ${shippingErrors.shippingCity ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                                  } focus:outline-none transition-all duration-200 bg-white hover:border-yellow-300`}
                              >
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 rounded-lg border-2 ${shippingErrors.shippingZip ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                                  } focus:outline-none transition-all duration-200 bg-white hover:border-yellow-300`}
                                placeholder="10001"
                              />
                            ...
                            <div className="space-y-4">
                              {shippingMethods.length > 0 ? (
                                shippingMethods.map((method) => {
                                  ...
                                  return (
                                    <div key={method.id} className={`relative border-2 rounded-lg p-5 cursor-pointer transition-all duration-200 ${selectedShippingId === method.id
                          ...
                          <div className="flex justify-between items-center pt-8">
                            ...
                            <button
                              ...
                              className={`px-8 py-3 rounded-lg font-medium transition-all duration-200 flex items-center ${selectedShippingId
                          ...
                          <div className="pt-8 border-t border-yellow-200">
                            ...
                            <div className="space-y-4">
                              ...
                              {enabledPaymentMethods.cod && (
                                <div className={`bg-white/70 border-2 rounded-xl p-6 hover:border-yellow-400 transition-colors cursor-pointer ${paymentMethod === 'cod' ? 'border-yellow-500 bg-yellow-50' : 'border-yellow-200'
                                  }`}>
                                  <div className="flex items-center">
                                    <input
                                      id="payment-cod"
                              ...
                              {enabledPaymentMethods.whatsapp && (
                                <div className={`bg-white/70 border-2 rounded-xl p-6 hover:border-yellow-400 transition-colors cursor-pointer ${paymentMethod === 'whatsapp' ? 'border-yellow-500 bg-yellow-50' : 'border-yellow-200'
                                  }`}>
                                  <div className="flex items-center">
                                    <input
                                      id="payment-whatsapp"
                              ...
                              {enabledPaymentMethods.telegram && (
                                <div className={`bg-white/70 border-2 rounded-xl p-6 hover:border-yellow-400 transition-colors cursor-pointer ${paymentMethod === 'telegram' ? 'border-yellow-500 bg-yellow-50' : 'border-yellow-200'
                                  }`}>
                                  <div className="flex items-center">
                                    <input
                                      id="payment-telegram"
                              ...
                              {Object.entries(enabledPaymentMethods).filter(([method]) => !['whatsapp', 'telegram', 'cod'].includes(method)).map(([method, config]: [string, any]) => {
                                ...
                                return (
                                  <div key={method} className={`bg-white/70 border-2 rounded-xl hover:border-yellow-400 transition-colors cursor-pointer ${paymentMethod === method ? 'border-yellow-500 bg-yellow-50' : 'border-yellow-200'
                                    }`}>
                            ...
                            <div className="pt-8 border-t border-yellow-200">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full px-4 py-3 rounded-lg border-2 ${paymentErrors.whatsappNumber ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-yellow-500'
                                    } focus:outline-none transition-all duration-200 bg-white hover:border-yellow-300`}
                                />
                  ...
                  <div className="p-6 lg:p-8">
                        ...
                        return (
                          <div key={item.id} className="flex items-center space-x-3 bg-white/10 rounded-lg p-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {renderVariants(item.variants, true)}
                    ...
                    <div className="space-y-3 border-t border-yellow-500 pt-6">
                      <div className="flex justify-between text-sm text-yellow-100">
                        <span>Subtotal</span>
                        <span className="font-medium">{formatCurrency(updatedCartSummary.subtotal, storeSettings as any, currencies as any)}</span>
                      </div>

                      {updatedCartSummary.discount > 0 && (
                        <div className="flex justify-between text-sm text-green-200">
                          <span>Discount</span>
                          <span className="font-medium">-{formatCurrency(updatedCartSummary.discount, storeSettings as any, currencies as any)}</span>
                        </div>
                      )}
                      ...
                      <div className="flex justify-between text-sm text-yellow-100">
                        ...
                        <span className="font-medium">
                          {selectedShippingId ? (updatedCartSummary.shipping === 0 ? 'FREE' : formatCurrency(updatedCartSummary.shipping, storeSettings as any, currencies as any)) : 'Select method'}
                        </span>
                      </div>

                      <div className="flex justify-between text-sm text-yellow-100">
                        <span>Tax</span>
                        <span className="font-medium">{formatCurrency(updatedCartSummary.tax, storeSettings as any, currencies as any)}</span>
                      </div>

                      <div className="flex justify-between text-lg font-semibold text-white pt-3 border-t border-yellow-400">
                        <span>Total</span>
                        <span>{formatCurrency(updatedCartSummary.total, storeSettings as any, currencies as any)}</span>
                      </div>
                    </div>
