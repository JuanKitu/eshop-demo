                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          ...
                          {(orderData.subtotal ?? 0) > 0 && (orderData.discount ?? 0) > 0 && (
                            <tr>
                              ...
                              <td className="px-6 py-4 text-right text-sm text-gray-600 font-light">
                                {formatCurrency(orderData.subtotal || 0, storeSettings as any, currencies as any)}
                              </td>
                            </tr>
                          )}
                          {(orderData.discount ?? 0) > 0 && (
                            <tr>
                              ...
                              <td className="px-6 py-4 text-right text-sm text-green-600 font-light">
                                {formatCurrency(orderData.discount || 0, storeSettings as any, currencies as any)}
                              </td>
                            </tr>
                          )}
                          {orderData.shipping && orderData.shipping > 0 && (
                            <tr>
                              ...
                              <td className="px-6 py-4 text-right text-sm text-gray-600 font-light">
                                {formatCurrency(orderData.shipping || 0, storeSettings as any, currencies as any)}
                              </td>
                            </tr>
                          )}
                          {orderData.tax && orderData.tax > 0 && (
                            <tr>
                              ...
                              <td className="px-6 py-4 text-right text-sm text-gray-600 font-light">
                                {formatCurrency(orderData.tax || 0, storeSettings as any, currencies as any)}
                              </td>
                            </tr>
                          )}
                          <tr className="bg-gray-50">
                            ...
                            <td className="px-6 py-4 text-right text-sm font-light text-black">
                              {formatCurrency(orderData.total || 0, storeSettings as any, currencies as any)}
                            </td>
                          </tr>
                        </tbody>
                      </table>
