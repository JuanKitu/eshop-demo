                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border ${shippingErrors.shippingFirstName ? 'border-red-500' : 'border-gray-300'
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border ${shippingErrors.shippingLastName ? 'border-red-500' : 'border-gray-300'
                              } font-light focus:outline-none focus:border-black transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border ${shippingErrors.shippingEmail ? 'border-red-500' : 'border-gray-300'
                              } font-light focus:outline-none focus:border-black transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border ${shippingErrors.shippingPhone ? 'border-red-500' : 'border-gray-300'
                              } font-light focus:outline-none focus:border-black transition-colors`}
                          />
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border ${shippingErrors.shippingStreet ? 'border-red-500' : 'border-gray-300'
                              } font-light focus:outline-none focus:border-black transition-colors`}
                          />
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 border ${shippingErrors.shippingState ? 'border-red-500' : 'border-gray-300'
                              } font-light focus:outline-none focus:border-black transition-colors`}
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 border ${shippingErrors.shippingCity ? 'border-red-500' : 'border-gray-300'
                              } font-light focus:outline-none focus:border-black transition-colors`}
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 border ${shippingErrors.shippingZip ? 'border-red-500' : 'border-gray-300'
                              } font-light focus:outline-none focus:border-black transition-colors`}
                          />
                                  ...
                                  {item.variants && Object.entries(item.variants).length > 0 && (
                                    <div className="text-xs text-gray-400 font-light mt-1">
                                      {Object.entries(item.variants).map(([key, value]) => (
                                        <span key={key} className="mr-2 italic">
                                          {key}: {String(value)}
                                        </span>
                                      ))}
                                    </div>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`block w-full px-4 py-3 border ${paymentErrors.whatsappNumber ? 'border-red-500' : 'border-gray-300'
                                } font-light focus:outline-none focus:border-black transition-colors`}
                            />
              ...
              <div className="lg:col-span-2">
                <div className="bg-black text-white p-8 sticky top-6">
                          ...
                          <div className="ml-4 flex flex-1 flex-col">
                            <div>
                              <div className="flex justify-between text-sm font-light text-white">
                                ...
                                <p className="ml-4">{formatCurrency(parseFloat(itemPrice as any) * item.quantity, storeSettings as any, currencies as any)}</p>
                              </div>
                              {item.variants && Object.entries(item.variants).length > 0 && (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between text-sm text-gray-300 font-light">
                      <p>Shipping</p>
                      <p>{selectedShippingId ? formatCurrency(updatedCartSummary.shipping, storeSettings as any, currencies as any) : 'Select method'}</p>
                    </div>

                    <div className="flex justify-between text-sm text-gray-300 font-light">
                      <p>Tax</p>
                      <p>{formatCurrency(updatedCartSummary.tax, storeSettings as any, currencies as any)}</p>
                    </div>

                    <div className="flex justify-between text-lg font-light text-white pt-4 border-t border-gray-600">
                      <p>Total</p>
                      <span className="font-medium">{formatCurrency(updatedCartSummary.total, storeSettings as any, currencies as any)}</span>
                    </div>
                  </div>
