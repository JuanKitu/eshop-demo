        ...
        {Object.entries(parsedVariants).map(([key, value]) => (
          <span
            ...
            className={`text-[10px] italic rounded-full px-2 py-0.5 ${isSidebar
              ...
              : 'text-rose-500 bg-rose-50 border border-rose-100 shadow-sm'
              }`}
          >
            {key}: {String(value)}
          </span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl border-2 ${shippingErrors.shippingFirstName ? 'border-red-500' : 'border-rose-200'
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl border-2 ${shippingErrors.shippingLastName ? 'border-red-500' : 'border-rose-200'
                              } focus:outline-none focus:border-rose-500 transition-colors bg-white/80`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl border-2 ${shippingErrors.shippingEmail ? 'border-red-500' : 'border-rose-200'
                              } focus:outline-none focus:border-rose-500 transition-colors bg-white/80`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl border-2 ${shippingErrors.shippingPhone ? 'border-red-500' : 'border-rose-200'
                              } focus:outline-none focus:border-rose-500 transition-colors bg-white/80`}
                          />
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl border-2 ${shippingErrors.shippingStreet ? 'border-red-500' : 'border-rose-200'
                              } focus:outline-none focus:border-rose-500 transition-colors bg-white/80`}
                          />
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 rounded-xl border-2 ${shippingErrors.shippingState ? 'border-red-500' : 'border-rose-200'
                              } focus:outline-none focus:border-rose-500 transition-colors bg-white/80`}
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-4 py-3 rounded-xl border-2 ${shippingErrors.shippingCity ? 'border-red-500' : 'border-rose-200'
                              } focus:outline-none focus:border-rose-500 transition-colors bg-white/80`}
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl border-2 ${shippingErrors.shippingZip ? 'border-red-500' : 'border-rose-200'
                              } focus:outline-none focus:border-rose-500 transition-colors bg-white/80`}
                          />
                        ...
                        <div className="space-y-4">
                          {shippingMethods.length > 0 ? (
                            shippingMethods.map((method) => {
                              ...
                              return (
                                <div key={method.id} className={`relative border-2 rounded-2xl p-6 cursor-pointer transition-all ${selectedShippingId === method.id ? 'border-rose-500 bg-rose-50' : 'border-rose-200 bg-white/60 hover:border-rose-300'
                                  }`}>
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          ...
                          {enabledPaymentMethods.cod && (
                            <div className={`relative border-2 rounded-2xl p-6 cursor-pointer transition-all ${paymentMethod === 'cod' ? 'border-rose-500 bg-rose-50' : 'border-rose-200 bg-white/60 hover:border-rose-300'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-cod"
                          ...
                          {enabledPaymentMethods.whatsapp && (
                            <div className={`relative border-2 rounded-2xl p-6 cursor-pointer transition-all ${paymentMethod === 'whatsapp' ? 'border-rose-500 bg-rose-50' : 'border-rose-200 bg-white/60 hover:border-rose-300'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-whatsapp"
                          ...
                          {enabledPaymentMethods.telegram && (
                            <div className={`relative border-2 rounded-2xl p-6 cursor-pointer transition-all ${paymentMethod === 'telegram' ? 'border-rose-500 bg-rose-50' : 'border-rose-200 bg-white/60 hover:border-rose-300'
                              }`}>
                              <div className="flex items-center">
                                <input
                                  id="payment-telegram"
                          ...
                          {Object.entries(enabledPaymentMethods).filter(([method]) => !['whatsapp', 'telegram', 'cod'].includes(method)).map(([method, config]: [string, any]) => {
                            ...
                            return (
                              <div key={method} className={`relative border-2 rounded-2xl cursor-pointer transition-all ${paymentMethod === method ? 'border-rose-500 bg-rose-50' : 'border-rose-200 bg-white/60 hover:border-rose-300'
                                }`}>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`block w-full px-4 py-3 rounded-xl border-2 ${paymentErrors.whatsappNumber ? 'border-red-500' : 'border-rose-200'
                                } focus:outline-none focus:border-rose-500 transition-colors bg-white/80`}
                            />
                      ...
                      return (
                        <div key={item.id} className="flex items-center space-x-4">
                          ...
                          <p className="text-sm font-medium text-white">
                            {formatCurrency(parseFloat(itemPrice as any) * item.quantity, storeSettings as any, currencies as any)}
                          </p>
                        </div>
                      );
                    })}
