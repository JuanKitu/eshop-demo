  ...
  return (
    <>
      <Head>
        ...
        {!post?.index_in_search && <meta name="robots" content="noindex,nofollow" />}
      </Head>
      ...
      <StoreLayout
        ...
        customFooter={<BeautyFooter storeName={store?.name || 'Store'} logo={store?.logo} />}
      >
        {/* Hero Section */}
        ...
        {post?.featured_image && (
          <div className="aspect-[16/9] max-w-5xl mx-auto mb-12">
            <img
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = `https://placehold.co/1200x675/fdf2f8/ec4899?text=${encodeURIComponent(post?.title || 'Blog Post')}`;
              }}
            />
          </div>
        )}
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-500">
                    ...
                    <span className="font-semibold text-gray-900">{post?.author?.name || 'Anonymous'}</span>
                  </div>
