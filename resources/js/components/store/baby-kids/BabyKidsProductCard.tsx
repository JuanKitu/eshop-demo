            ...
            <div className={`absolute inset-0 bg-pink-500/20 flex items-center justify-center transition-opacity duration-300 ${isHovered ? 'opacity-100' : 'opacity-0'}`}>
              <div className="flex space-x-3">
                <button
                  ...
                  className={`p-3 rounded-full transition-all duration-300 shadow-lg transform hover:scale-110 ${isProductInWishlist
              ...
              {product.sale_price ? (
                <>
                  <span className="text-xl font-bold text-red-500">
                    {formatCurrency(product.sale_price as any, storeSettings as any, currencies as any)}
                  </span>
                  <span className="text-sm text-gray-500 line-through">
                    {formatCurrency(product.price as any, storeSettings as any, currencies as any)}
                  </span>
                </>
              ) : (
