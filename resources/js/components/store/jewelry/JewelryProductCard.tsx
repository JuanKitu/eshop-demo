    ...
    <div className="group bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-6 text-center">
        ...
        <div className="flex items-center justify-center space-x-2 mb-3">
          {product.sale_price ? (
            <>
              <span className="text-xl font-medium text-neutral-900">{formatCurrency(product.sale_price, finalStoreSettings as any, finalCurrencies as any)}</span>
              <span className="text-sm text-neutral-500 line-through">{formatCurrency(product.price, finalStoreSettings as any, finalCurrencies as any)}</span>
            </>
          ) : (
            <span className="text-xl font-medium text-neutral-900">{formatCurrency(product.price, finalStoreSettings as any, finalCurrencies as any)}</span>
          )}
        </div>
